    ...
    return (
        <div className="aboutMe">
            ...
            <div className="aboutMeDetails">
                ...
                <p>
                    I was born in Aberdeen, South Dakota and raised in the Northern Black Hills. I have always had a passion for art, technology, and problem-solving, which initially led me to pursue a career in Technical Theatre.
                    I trained in technical theatre in my time at South Dakota State University and later working at the CAM-PLEX of Wyoming; including lighting, rigging, carpentry, sound/audio, and stage management. Throughout I gained valuable technical skills and experience in project management, teamwork, and communication.
                    I also have an Associates of Applied Science in Culinary Arts from Mitchell Technical College, which has given me a unique perspective on dedication, creation, creativity, and attention to detail. I have always enjoyed cooking and working with others in a kitchen, and I believe that these skills have helped me develop a strong work ethic and a passion for creating. Not to mention my wife enjoys me being handy in the kitchen.
                    I have recently completed a Full-Stack Developer bootcamp from the University of Oregon, where I am learned the latest technologies and best practices in software and web development. I am excited to apply my skills and knowledge to create innovative and user-friendly applications that solve real-world problems.
